...
ContactAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showProgress(true);
        tvLoad.setText("Wait.. we are getting your contacts");

        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent=new Intent(ContactList.this,ContactEdit.class);
        ...
        Backendless.Persistence.of(Contact.class).find(builder, new AsyncCallback<List<Contact>>() {
            @Override
